...
public class PotionRemoveEvent extends PotionEvent {
    private static final HandlerList handlers = new HandlerList();

    @Getter
    private final ActivePotion activePotion;

    public PotionRemoveEvent(Player who, PotionConfig potionConfig, ActivePotion activePotion) {
    ...
    public static void callEvent(Player who, PotionConfig potionConfig, ActivePotion activePotion) {
        Bukkit.getPluginManager().callEvent(new PotionRemoveEvent(who, potionConfig, activePotion));
    }
